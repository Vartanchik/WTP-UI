...
export class UserListComponent implements OnInit {
  ...
  load() {
    this.http.get<UserIndexViewModel>(this.baseUrl + 'api/Admin/users/newpagination?name='+this.searchByName+'&page='+this.pageNumber+'&sortorder='+this.selectedNumber+'&enableDeleted='+this.enableDeleted+'&enableLocked='+this.enableLocked).subscribe(result => {
  ...
  this.http.get<UserIndexViewModel>(this.baseUrl + 'api/Admin/users/newpagination?name='+this.searchByName+'&page='+pageNumber+'&sortorder='+this.selectedNumber+'&enableDeleted='+this.enableDeleted+'&enableLocked='+this.enableLocked).subscribe(result => {
